;(function(win) {
  function setOtherSize() {
    ...
    fontEl.innerHTML = "html{font-size:" + win.rem + "px!important;}body{font-size:" + 12 * (cWidth / 320) + "px" + str;
  }
  ...
  if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
    ...
    !browserVer || browserVer && browserVer[1] > 534 ? metaEl.setAttribute("content", "target-densitydpi=device-dpi,width=device-width,user-scalable=no,initial-scale=" + scale + ",maximum-scale=" + scale + ", minimum-scale=" + scale) : dpr = 1;
